-- ============================================================================
-- 019 — Confidence and form
--
-- Confidence is based on the last six scored league matches:
--
--   raw participation = player appearances in those six / 6
--   confidence        = 100% when raw participation is above 60%, otherwise raw
--
-- The donut shows confidence. The rating correction uses raw participation:
--
--   adjusted rating = floor(base rating - 10 * (100 - raw participation) / 100)
--
-- Form is derived from the player's own latest match rating scores, where each
-- match rating score already includes victory and attributes through
-- final_score.
-- ============================================================================
